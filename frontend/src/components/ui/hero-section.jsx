...
import { ArrowRight, Building2, CalendarDays, CheckCircle2, ChevronDown, FileCheck2, FileText, Search, Upload } from 'lucide-react';
...
const STATUS_STYLES = {
  ...
  publicado: 'border-secondary-200 bg-secondary-50 text-secondary-800',
...
export function HeroSection({ data, onLogin }) {
  return <div className="min-h-screen bg-[#f7f8fa] text-slate-950"><main>
