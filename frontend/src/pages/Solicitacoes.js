                  ...
                  <CardContent className="p-6">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex-1 bg-zinc-800 rounded-full h-1.5">
                            <div className="bg-orange-500 h-1.5 rounded-full" style={{ width: `${sol.progresso}%` }} />
                          </div>
                          <span className="text-xs font-mono text-orange-400">{sol.progresso}%</span>
                        </div>
                      </div>
                      {sol.status === 'rascunho' && (
                        <Button onClick={() => handleSubmeter(sol.solicitacao_id)} className="bg-orange-500 hover:bg-orange-600 text-white text-sm h-9 px-4 shrink-0">
                    ...
                    {sol.observacoes_detran && (
                      <div className="mt-3 p-3 bg-zinc-800/50 rounded-lg border border-zinc-700/50">
                        <p className="text-xs text-zinc-400"><span className="text-orange-400 font-mono">DETRAN:</span> {sol.observacoes_detran}</p>
                      </div>
                    )}
                  </CardContent>
                </Card>
