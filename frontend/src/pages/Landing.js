          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                ...
                className="bg-zinc-950/50 backdrop-blur-sm border border-zinc-800/60 rounded-lg p-6 hover:border-primary-500/30 card-hover group"
              >
                <div className="mb-4 inline-flex items-center justify-center w-12 h-12 rounded-lg bg-primary-500/10 text-primary-500 group-hover:bg-primary-500/20">
