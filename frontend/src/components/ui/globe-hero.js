...
const Globe = ({ rotationSpeed = 0.003, radius = 1.2 }) => {
  ...
  return (
    <group ref={ref}>
      <mesh><sphereGeometry args={[radius, 48, 48]} /><meshBasicMaterial color="#c59b27" transparent opacity={0.07} wireframe /></mesh>
      <mesh><sphereGeometry args={[radius*0.97, 24, 24]} /><meshBasicMaterial color="#e4c45f" transparent opacity={0.03} wireframe /></mesh>
    </group>
  );
};
    ...
    <div style={{ position:"relative", width:"100%", overflow:"hidden", ...style }}>
      ...
      <div style={{ position:"absolute", inset:0, zIndex:0, pointerEvents:"none" }}>
        <Canvas>
          ...
          <pointLight position={[10,10,10]} intensity={0.6} color="#c59b27" />
